...
drought_clean |> 
  ...
  # includes major/minor grid lines + no axes
  theme_minimal() +
  
  theme(
    # remove axis + legend title
    axis.title = element_blank(),
    legend.title = element_blank(),
    
    # move and update size of legend
    ...
    # update title position, font size, and color
    plot.title = element_text(hjust = 0.5,
                              color = "#686868",
                              size = 20,
                              margin = margin(t = 10, r = 0, b = 15, l = 0)),
    
    # update legend + axis font size
