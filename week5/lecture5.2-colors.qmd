...
# discrete viridis scales (categorical) ----
cat_color_plot +
  scale_color_viridis_d()

# continuous color scales (continuous) ----
con_color_plot +
...
# when you update color to fill in aesthetics, make sure you change the scale_color_distiller too to scale_fill_distiller
```
