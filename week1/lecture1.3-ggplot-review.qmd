...
Mapping color to a categorical variable (species)
...
Mapping color to continuous variables (e.g. body_mass_g)
...
Coloring all points the same --> here, color is no longer being mapped to a variable
